...
public class Practice_day03 extends TestBaseClass2 {
    ...
    public void test01(){
        ...
        String expeactedOdemeBasarali = "The payment was successfully submitted.";
        String actualOdeme =driver.findElement(By.xpath("//*[text()='The payment was successfully submitted.']")).getText();


        Assertions.assertEquals(expeactedOdemeBasarali, actualOdeme);
